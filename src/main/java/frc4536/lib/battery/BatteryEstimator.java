 ...
 * whitepaper detailing an algorithm developed for the 2016 FRC season by FRC1736
 *
 */
public class BatteryEstimator {
	...
	public BatteryEstimator(final int length) {
    ...
    public void setConfidenceThresh(final double Thresh_A) {
     ...
     */
    public void updateEstimate(final double measSysVoltage_V, final double measSysCurrent_A) {
        ...
        final double sumV = findSum(circ_buf_SysVoltage_V);
        final double sumI = findSum(circ_buf_SysCurDraw_A);
        final double sumIV = findDotProd(circ_buf_SysCurDraw_A, circ_buf_SysVoltage_V);
        final double sumI2 = findDotProd(circ_buf_SysCurDraw_A, circ_buf_SysCurDraw_A);
        final double meanV = sumV / lms_window_length;
        final double meanI = sumI / lms_window_length;
        ...
        final double spread_I = findStdDev(circ_buf_SysCurDraw_A);
     ...
     */
    public double getEstVsys(final double Idraw_A) {
     ...
     */
    public double getMaxIdraw(final double VsysMin_V) {
     ...
     */
    private double findSum(final double[] input) {
        double sum = 0;
     ...
     */
    private double findDotProd(final double[] A, final double[] B) {
        double sum = 0;
