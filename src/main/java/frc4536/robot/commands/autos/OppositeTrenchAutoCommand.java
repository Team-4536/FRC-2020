...
public class OppositeTrenchAutoCommand extends SequentialCommandGroup {
  public OppositeTrenchAutoCommand(Shooter shooter, Conveyor conveyor,
                                   DriveTrain driveTrain, Intake intake,
                                   Pose2d initialPose,
                                   Trajectory oppositeEndToShoot) {
    Pose2d shootPosition =
        Poses.RENDEZ_SHOOT; // TODO: GET POSES FOR OPPOSITE TRENCH RUN
    Trajectory oppositeTrenchRun = TrajectoryGenerator.generateTrajectory(
    ...
    addCommands(
        ...
        driveTrain.scurveTo(oppositeTrenchRun)
