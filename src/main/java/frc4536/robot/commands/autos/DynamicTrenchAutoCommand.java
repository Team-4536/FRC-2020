...
public class DynamicTrenchAutoCommand extends SequentialCommandGroup {
    public DynamicTrenchAutoCommand(Shooter shooter, Conveyor conveyor, DriveTrain driveTrain, Intake intake, Pose2d initalPose, Trajectory shootToEnd, Trajectory endToShoot) {
