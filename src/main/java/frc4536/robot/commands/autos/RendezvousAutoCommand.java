...
public class RendezvousAutoCommand extends SequentialCommandGroup {
  public RendezvousAutoCommand(Shooter shooter, Conveyor conveyor,
                               DriveTrain driveTrain, Intake intake,
                               Pose2d initialPose, Trajectory shootToRendez,
                               Trajectory RendezToShoot) {
    ...
    addCommands(
        driveTrain.scurveTo(toRendezShoot)
        ...
        driveTrain.scurveTo(shootToRendez)
            .raceWith(new IntakeCommands(intake, conveyor)),
