...
import static frc4536.robot.hardware.Honeycomb.kWheelDiameterInches;

public class DriveTrain extends SubsystemBase {
    private final IEncoderMotor m_leftMotor, m_rightMotor;
    private final AHRS m_navx;
    private Pose2d m_pose;
    private double wheelCircumference = Units.inchesToMeters(kWheelDiameterInches) * Math.PI;
